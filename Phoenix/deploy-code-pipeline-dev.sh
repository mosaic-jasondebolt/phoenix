...
VERSION=`jq -r '.Parameters.Version' template-code-pipeline-params-dev.json`
...
aws cloudformation $1-stack --stack-name $PROJECT_NAME-code-pipeline-$ENVIRONMENT-$VERSION \
