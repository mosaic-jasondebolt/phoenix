...
# USAGE:
#   ./deploy-github-webhook-release.sh [create | update]
#
# EXAMPLES:
#   ./deploy-github-webhook-release.sh create
#   ./deploy-github-webhook-release.sh update
...
python parameters_generator.py template-github-webhook-release-params.json cloudformation > temp1.json
...
sed "s/__PROJECT_NAME__LambdaMacro/${PROJECT_NAME}LambdaMacro/g" template-github-webhook.json > temp0.json
