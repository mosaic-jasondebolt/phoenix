...
# USAGE:
#   ./deploy-pull-request-webhook.sh [create | update]
#
# EXAMPLES:
#   ./deploy-pull-request-webhook.sh create
#   ./deploy-pull-request-webhook.sh update
...
listOfLambdaFunctions='pull_request_webhook post_pullrequests github_custom_authorizer'
...
python parameters_generator.py template-pull-request-webhook-params.json cloudformation > temp1.json
...
aws cloudformation validate-template --template-body file://template-pull-request-webhook.json

aws cloudformation create-change-set --stack-name $STACK_NAME \
    --change-set-name $CHANGE_SET_NAME \
    --template-body file://template-pull-request-webhook.json \
