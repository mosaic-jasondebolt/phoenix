...
# Handles GitHub webhook token authorization

# For more information about API Gateway Lambda Authorizers
...
def lambda_handler(event, context):
    ...
    hashToken = event['authorizationToken']
    # See https://developer.github.com/webhooks/ for an example token value
    hashValue = hashToken.split('sha1=')[1].strip()
    print(hashValue)

    print(get_github_webhook_secret_token())

    print(hashValue == get_github_webhook_secret_token())
    #print(str(event['authorizationToken']) == get_github_webhook_secret_token())

    if not hashValue == get_github_webhook_secret_token():
