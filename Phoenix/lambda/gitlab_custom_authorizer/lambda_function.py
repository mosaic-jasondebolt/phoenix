...
# Handles GitLab webhook token authorization
...
def lambda_handler(event, context):
    ...
    #print(get_gitlab_webhook_secret_token())
    #print(str(event['authorizationToken']))
    #print(str(event['authorizationToken']) == get_gitlab_webhook_secret_token())

    if not str(event['authorizationToken']) == get_gitlab_webhook_secret_token():
